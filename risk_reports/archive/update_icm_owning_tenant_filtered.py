...
# ICM data filtered by OwningTenantName != "SCIM Escalation Management"
icm_data = [
...
{'IncidentId': 675908430, 'Severity': 3, 'OwningContactAlias': 'harsjain', 'Status': 'ACTIVE'},
...
print(f'✓ Updated ICM data: {len(df)} ICMs (filtered by OwningTenantName != "SCIM Escalation Management")')
print(f'\nStatus breakdown:')
