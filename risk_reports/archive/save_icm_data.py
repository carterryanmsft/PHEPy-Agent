...
# All 135 ICMs with current status from the query (filtered: no SCIM Escalation Management)
icm_data = [
    ...
    {"IncidentId": 727018861, "Severity": 3, "OwningContactAlias": "v-pparkale", "Status": "ACTIVE"},
    ...
    {"IncidentId": 21000000868738, "Severity": 3, "OwningContactAlias": "salonievyas", "Status": "MITIGATED"},
    ...
    {"IncidentId": 51000000857946, "Severity": 3, "OwningContactAlias": "sourpandey", "Status": "ACTIVE"},
...
# Save to CSV
output_file = 'data/icm.csv'
df.to_csv(output_file, index=False)

print(f'✓ Saved {len(df)} ICMs to {output_file}')
print(f'\nStatus breakdown:')
print(df['IcmStatus'].value_counts())
print(f'\nICMs with owners: {(df["IcmOwner"] != "").sum()} of {len(df)}')
print(f'\nNow regenerate the report:')
print('python ic_mcs_risk_report_generator.py ../data/production_full_cases.csv IC_MCS_COMPLETE_REPORT.htm data/icm.csv')
