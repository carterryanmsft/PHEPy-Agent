...
def generate_risk_report_html(kusto_results_input, icm_results_csv=None, output_html="IC_MCS_Risk_Report.htm"):
    ...
    def recalculate_risk_score(row):
        ...
        # Calculate original case age contribution
        if days_open > 180:
            original_age_points = 40
        elif days_open > 120:
            original_age_points = 35
        elif days_open > 90:
            original_age_points = 30
        elif days_open > 60:
            original_age_points = 25
        elif days_open > 30:
            original_age_points = 20
        else:
            original_age_points = 10
...
<td class="left-align">{row['Summary']}</td>
