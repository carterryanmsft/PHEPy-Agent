#!/usr/bin/env python3
"""
Generate CIBC Purview Case History Report
"""
import json
...
# Load case data
with open("data/purview_case_history_CIBC_6mo.json", "r", encoding="utf-8") as f:
    content = f.read()
...
<head>
    ...
    <title>CIBC Purview Case History - 6 Month Analysis</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 CIBC Purview Case History Analysis</h1>
            <div class="subtitle">Canadian Imperial Bank of Commerce - 6 Month Case Review</div>
            <div class="subtitle">Subscription: 222fcaf7-15d0-455f-97e1-8fda2eaad539</div>
            <div class="meta">
...
# Save report
output_path = Path("risk_reports/CIBC_Purview_Case_History_6mo.htm")
